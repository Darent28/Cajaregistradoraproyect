...
namespace Sistema.Negocio
{
    public class N_Recibos
    {
        public static string sp_Recibo(int IdRecibo, string codigo, string Cajero, string caja, string produc,
                                    string forma_pago, string departamento, float cantidad, float subtotal, float total, DateTime fecha_creacion)
        {
        ...
        public static DataTable sp_GetReporteCajeroTodos(string fecha1, string fecha2)
        {
            D_Recibos admin = new D_Recibos();
            return admin.sp_GetReporteCajeroTodos(fecha1, fecha2);
        }

        public static DataTable sp_GetReporteVentasTodas(string fecha1, string fecha2)
        {
            D_Recibos admin = new D_Recibos();
            return admin.sp_GetReporteVentasTodas(fecha1, fecha2);
        }
