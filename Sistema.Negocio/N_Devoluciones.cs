...
namespace Sistema.Negocio
{
    public class N_Devoluciones
    {
        ...
        public static DataTable sp_GetInventarioTodo(int canExi)
        {
            D_Devoluciones Datos = new D_Devoluciones();
            return Datos.sp_GetInventarioTodo(canExi);
        }

        public static DataTable sp_GetInventarioTodoMerma( int canExi, string merma)
        {
            D_Devoluciones Datos = new D_Devoluciones();
            return Datos.sp_GetInventarioTodoMerma(canExi, merma);
        }
