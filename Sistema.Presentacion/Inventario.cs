    ...
    public partial class Inventario : Form
    {
        ...
        private void btn_buscartodas_Click(object sender, EventArgs e)
        {
            ...
            if (merma.Checked == true)
            {
                ...
                Dgv_inventario.DataSource = N_Devoluciones.sp_GetInventarioTodoMerma(cantidad_, merma_);
            ...
            else if (merma.Checked == false)
            {
                ...
                Dgv_inventario.DataSource = N_Devoluciones.sp_GetInventarioTodo(cantidad_);
        ...
        private void Existencia_ValueChanged(object sender, EventArgs e)
        {
