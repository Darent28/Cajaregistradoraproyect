...
namespace Sistema.Presentacion
{
    public partial class ReporteVentas : Form
    {
        ...
        {
            Dgv_rVentas.DataSource = N_Recibos.sp_GetReporteVentasTodas(dtp_fInicio.Text, dtp_fFin.Text);
        ...
        private void cb_Caja_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar >= 00 && e.KeyChar <= 255))
            {
                MessageBox.Show("No escribir en este campo", "Informacion", MessageBoxButtons.OK, MessageBoxIcon.Error);
