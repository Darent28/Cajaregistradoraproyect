...
namespace Sistema.Presentacion
{
    public partial class Departamento : Form
    {
        ...
        private void btn_aceptar_Click(object sender, EventArgs e)
        {
            ...
            {
                string respuesta = N_Departamento.sp_GestionarDepartamentosInserto(Registered_by_, NomCompleto_, devolu_,"I");
                if (respuesta.Equals("OK"))
                {
        ...
        private void btn_Modificar_Click(object sender, EventArgs e)
        {
            ...
            {
                string respuesta = N_Departamento.sp_GestionarDepartamentos(id_, Registered_by_, NomCompleto_, devolu_, "U");
        ...
        {
            if (Dgv_rDepartamento.RowCount < 1)
            {
                return;
            }
            else
        ...
        private void btn_bajalogica_Click(object sender, EventArgs e)
        {
            ...
            {
                string respuesta = N_Departamento.sp_GestionarDepartamentos(id_, Registered_by_, NomCompleto_, devolu_, "B");
